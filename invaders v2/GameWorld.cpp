...
GameWorld::GameWorld(ID3D11Device *device, e::XMVECTOR pos)
	:playerBullets(device, RM::Get().GetModel(RM::MODEL_BULLET), RM::Get().GetShader<ColorInstancedShader>(), 100, 0.01f, e::XMFLOAT2(0.0f, 1.0f), GAME_EVENT_PLAYER_BULLET_CREATE),
	collider(),
