...
:player(pos - e::XMVectorSet(0.0f, size.y / 2.0f, 0.0f, 0.0f), 500, 0.02f, 10, 100, RM::Get().GetModel(RM::MODEL_PLAYER), RM::Get().GetShader<ColorShader>(), e::XMFLOAT4(0.0f, 1.0f, 0.3f, 1.0f)),
